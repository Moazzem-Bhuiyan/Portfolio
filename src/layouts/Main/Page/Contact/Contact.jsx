...
import BackgroundAnimation from '../../../../BackGroundAnimation/Backgroundanimation';
  // Import the background animation
...
const ContactForm = () => {
  ...
  return (
    <div className="relative">
      <BackgroundAnimation />  {/* Add 3D background */}
      
      <div className="contact-form-section bg-white p-8 md:p-10 lg:p-12 text-black relative z-10">
